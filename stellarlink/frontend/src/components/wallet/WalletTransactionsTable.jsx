...
export default function WalletTransactionsTable({ onInspectTx }) {
          ...
          <div key={tx.txId} className="p-4 rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className={`h-9 w-9 rounded-xl flex items-center justify-center border ${tx.amount.startsWith('+') ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-slate-100 text-[#0F172A] border-[#E2E8F0]'}`}>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#E2E8F0] text-xs">
              <div>
                ...
                <span className={`font-mono font-bold ${tx.amount.startsWith('+') ? 'text-emerald-700' : 'text-[#0F172A]'}`}>{tx.amount}</span>
              </div>
              <div>
