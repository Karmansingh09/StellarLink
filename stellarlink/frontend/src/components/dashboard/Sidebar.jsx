...
export default function Sidebar({ navItems }) {
  return (
    <>
      <aside className="sticky top-0 hidden h-screen w-72 shrink-0 border-r border-[#E2E8F0]/80 bg-white/90 px-5 py-6 backdrop-blur-xl lg:flex lg:flex-col">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-[#E2E8F0]/80 bg-white/95 backdrop-blur-xl lg:hidden">
          ...
          {navItems.slice(0, 5).map((item) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    'flex flex-col items-center justify-center gap-1 rounded-[14px] px-2 py-2 text-[11px] font-medium transition-colors',
                    isActive ? 'bg-[#EAF8F6] text-[#0F766E]' : 'text-[#64748B]'
                  )
                }
              >
                {({ isActive }) => (
                  ...
                  >
                    <span
                      className={clsx(
                        ...
                        isActive ? 'border-[#CBE9E3] bg-white text-[#0F766E]' : 'border-transparent bg-transparent text-[#64748B]'
                      )}
                    >
                      <Icon className="h-4 w-4" />
                    </span>
