  ...
  return (
    <Card padding="generous" className="h-full min-w-0">
      <CardHeader className="mb-2">
        ...
        <CardDescription className="text-xs">Weekly settlement volume (XLM)</CardDescription>
      </CardHeader>
      <div className="h-56 sm:h-64 w-full pt-2">
        {isLoading ? (
          ...
          <EmptyState
            ...
            description="No weekly settlement volume recorded on Stellar Testnet for this fleet."
          />
        ) : (
