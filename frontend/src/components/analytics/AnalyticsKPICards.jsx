  ...
  const kpis = [
    {
      ...
      change: { label: metrics?.throughputGrowth && metrics.throughputGrowth !== 'N/A' ? `Growth ${metrics.throughputGrowth}` : 'Stellar Testnet', tone: 'success' },
      icon: Activity,
      tone: 'primary',
    },
    {
    ...
    {
      title: 'Ledger Block Time',
      value: isLoading ? '...' : (metrics?.ledgerCloseCadenceMs || 'N/A'),
      change: { label: 'Stellar Cadence', tone: 'warning' },
      icon: Clock,
      tone: 'warning',
    },
    {
